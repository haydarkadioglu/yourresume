      ...
      <main className="flex-grow container mx-auto py-12 md:py-24 lg:py-32 px-4 md:px-6">
        <div className="flex justify-center">
            <div className="w-full max-w-5xl relative">
                <div className="h-[450px] md:h-[550px] rounded-xl overflow-hidden shadow-2xl">
                    <iframe
                ...
                <div className="absolute top-8 left-8">
                    <Card className="w-full max-w-sm bg-card/90 backdrop-blur-sm border-primary/20 shadow-lg">
                        <CardHeader>
