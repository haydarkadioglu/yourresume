...
const translations = {
  en: {
    ...
    customizeLayoutDesc: "Move sections between the main content area and the sidebar to create your perfect layout.",
    mainContent: "Main Content",
    sidebar: "Sidebar",
    mainContentEmpty: "Add sections to the main content area.",
    sidebarEmpty: "Add sections to the sidebar.",
    layoutEditorNote: "Your layout settings only apply to the 'Create Your Own' template. You can change the order of sections in the 'Content' tab.",
  ...
  tr: {
    ...
    layoutEditorNote: "Yerleşim ayarlarınız yalnızca 'Kendin Oluştur' şablonu için geçerlidir. Bölümlerin sırasını 'İçerik' sekmesinden değiştirebilirsiniz.",
