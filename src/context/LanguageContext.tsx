...
const translations = {
  en: {
    ...
    newUserDisabled: "New user creation is disabled. Accounts are created manually.",
  ...
  tr: {
    ...
    newUserDisabled: "Yeni kullanıcı oluşturma devre dışı bırakılmıştır. Hesaplar manuel olarak oluşturulur.",
