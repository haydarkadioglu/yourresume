...
const translations = {
  en: {
    ...
    twoColumnLayoutDesc: "Organize sections between the sidebar and main content.",
    openLayoutEditor: "Open Layout Editor",
    ...
    customizeLayoutDesc: "Drag and drop sections between the main content area and the sidebar to create your perfect layout.",
    mainContent: "Main Content",
    sidebar: "Sidebar",
    mainContentEmpty: "Add sections to the main content area.",
    sidebarEmpty: "Add sections to the sidebar.",
    layoutEditorNote: "Your layout settings only apply to the 'Two-Column' template. You can change the order of sections in the 'Content' tab.",
  },
  tr: {
    home: "Anasayfa",
    contact: "İletişim",
    ...
    twoColumnLayout: "İki Sütunlu Düzen",
    twoColumnLayoutDesc: "Bölümleri kenar çubuğu ve ana içerik arasında düzenleyin.",
    openLayoutEditor: "Yerleşim Düzenleyiciyi Aç",
    ...
    customizeLayoutDesc: "Mükemmel düzeni oluşturmak için bölümleri ana içerik alanı ve kenar çubuğu arasında taşıyın.",
    ...
    layoutEditorNote: "Yerleşim ayarlarınız yalnızca 'İki Sütunlu' şablon için geçerlidir. Bölümlerin sırasını 'İçerik' sekmesinden değiştirebilirsiniz.",
  },
};
