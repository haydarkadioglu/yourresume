...
const translations = {
  en: {
    ...
    templateBuilderDesc: "Create your own unique CV template",
    templateSaved: "Template Saved",
    templateSavedDesc: "Your custom template has been saved successfully",
    templateSettings: "Template Settings",
    livePreview: "Live Preview",
    layoutStructure: "Layout Structure",
    columnConfiguration: "Column Configuration",
    leftColumn: "Left Column (Sidebar)",
    rightColumn: "Right Column (Main)",
    pageMargin: "Page Margin",
    tightMargin: "Tight (More content)",
    normalMargin: "Normal",
    wideMargin: "Wide (More whitespace)",
    primaryColor: "Primary Color",
    secondaryColor: "Secondary Color",
    fontFamily: "Font Family",
    fontSize: "Font Size",
    smallFont: "Small (Compact)",
    mediumFont: "Medium",
    largeFont: "Large (Readable)",
    spacing: "Spacing",
    ...
    minimal: "Minimal",
    bordered: "Bordered",
    coloredHeaders: "Colored Headers",
    borderRadius: "Border Radius",
    noneRadius: "None (Sharp corners)",
    smallRadius: "Small",
    mediumRadius: "Medium",
    largeRadius: "Large (Rounded)",
  ...
  tr: {
    ...
    templateBuilder: "Şablon Oluşturucu",
    templateBuilderDesc: "Kendi benzersiz CV şablonunuzu oluşturun",
    templateSaved: "Şablon Kaydedildi",
    templateSavedDesc: "Özel şablonunuz başarıyla kaydedildi",
    templateSettings: "Şablon Ayarları",
    livePreview: "Canlı Önizleme",
    layoutStructure: "Düzen Yapısı",
    columnConfiguration: "Sütun Yapılandırması",
    leftColumn: "Sol Sütun (Kenar Çubuğu)",
    rightColumn: "Sağ Sütun (Ana)",
    pageMargin: "Sayfa Kenar Boşluğu",
    tightMargin: "Dar (Daha fazla içerik)",
    normalMargin: "Normal",
    wideMargin: "Geniş (Daha fazla boşluk)",
    primaryColor: "Ana Renk",
    secondaryColor: "İkincil Renk",
    fontFamily: "Yazı Tipi Ailesi",
    fontSize: "Yazı Tipi Boyutu",
    smallFont: "Küçük (Kompakt)",
    mediumFont: "Orta",
    largeFont: "Büyük (Okunabilir)",
    spacing: "Boşluk",
    compactSpacing: "Kompakt",
    normalSpacing: "Normal",
    relaxedSpacing: "Rahat",
    headerStyle: "Başlık Stili",
    leftAligned: "Sola Hizalı",
    centered: "Ortalanmış",
    rightAligned: "Sağa Hizalı",
    sectionStyle: "Bölüm Stili",
    minimal: "Minimal",
    bordered: "Kenarlıklı",
    coloredHeaders: "Renkli Başlıklar",
    borderRadius: "Köşe Yuvarlaklığı",
    noneRadius: "Yok (Keskin köşeler)",
    smallRadius: "Küçük",
    mediumRadius: "Orta",
    largeRadius: "Büyük (Yuvarlak)",
    showIcons: "İkonları Göster",
    backToAppearance: "Görünüme Geri Dön",
