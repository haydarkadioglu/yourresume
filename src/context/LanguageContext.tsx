...
const translations = {
  en: {
    ...
    customizeLayoutDesc: "This panel lets you fully customize how your resume sections appear. Use the arrow buttons to move sections between the Main Content and the Sidebar to create your ideal layout.",
    mainContent: "Main Content",
    sidebar: "Sidebar",
    mainContentEmpty: "Add sections to the main content area.",
    sidebarEmpty: "Add sections to the sidebar.",
    layoutEditorNote: "Note: This layout only applies to the “Create Your Own” template. You can change the section order in the 'Content' tab. Don't forget to click Save Layout!",
    doubleClickToEdit: "Double-click to edit layout.",
    howItWorks: "How it works",
    mainContentInfo: "Main Content is your primary area — great for detailed sections like Work Experience and Projects.",
    sidebarInfo: "Sidebar is ideal for concise content like Skills, Education, and Certifications.",
  },
  tr: {
    home: "Anasayfa",
    contact: "İletişim",
    ...
    customizeLayout: "Düzeninizi Özelleştirin",
    customizeLayoutDesc: "Bu panel, özgeçmiş bölümlerinizin nasıl görüneceğini tamamen özelleştirmenizi sağlar. İdeal düzeninizi oluşturmak için ok butonlarını kullanarak bölümleri Ana İçerik ve Kenar Çubuğu arasında taşıyın.",
    mainContent: "Ana İçerik",
    sidebar: "Kenar Çubuğu",
    mainContentEmpty: "Ana içerik alanına bölüm ekleyin.",
    sidebarEmpty: "Kenar çubuğuna bölüm ekleyin.",
    layoutEditorNote: "Not: Bu düzen yalnızca 'Kendin Oluştur' şablonu için geçerlidir. Bölüm sırasını 'İçerik' sekmesinden değiştirebilirsiniz. Değişiklik yaptıktan sonra Düzeni Kaydet'e tıklamayı unutmayın!",
    doubleClickToEdit: "Düzeni düzenlemek için çift tıklayın.",
    howItWorks: "Nasıl çalışır?",
    mainContentInfo: "Ana İçerik, İş Deneyimi ve Projeler gibi detaylı bölümler için birincil alanınızdır.",
    sidebarInfo: "Kenar Çubuğu, Yetenekler, Eğitim ve Sertifikalar gibi daha öz içerikler için idealdir.",
  },
};
